...
import com.web365.buy_am.field.search.Buy_amSearchFilterAll;

public class Buy_amSearchFilterAllTest extends Buy_amBaseTest {

	@Test
	public void searchFilterAllTest() {
		System.out.println("Test Case ID  Search7");
		System.out.println("Verify user is able to filter searches to All");
		Buy_amSearchFilterAll search = new Buy_amSearchFilterAll(driver);
		...
		search = search.allButtonType();
		System.out.println("Step2 Click on the 'All' button");
